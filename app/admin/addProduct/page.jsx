...
const page = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        formData.append('authorImg', data.authotImg)
    ...
    return (
        <>
            <form onSubmit={onSubmitHandler} className="pt-5 px-5 sm:pt-12 sm:pl-16">
                ...
                <label htmlFor="image">
                    <Image src={!image ? assets.upload_area : URL.createObjectURL(image)} className='mt-4' width={140} height={70} alt='' />
                </label>
